    ...
    <!-- Header -->
    <header class="w3-container w3-red w3-center" style="padding:250px 16px">
      <h1 class="w3-margin w3-jumbo">WELCOME TO</h1>
      <p class="w3-xlarge" style="color:black">Library...</p>
      <a href="book_registration.php" class="w3-button w3-green w3-padding-large w3-large w3-margin-top">Book Registration</a><br>
      <a href="books_list.php" class="w3-button w3-white w3-padding-large w3-large w3-margin-top">All Books</a>
    </header>
